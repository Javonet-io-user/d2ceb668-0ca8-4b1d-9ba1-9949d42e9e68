...
public class TradeResult {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<ErrorCode> getError() {
    try {
      Object res = javonetHandle.<NObject>get("Error");
      if (res == null) return null;
      return new Nullable<ErrorCode>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public PendingOrder getPendingOrder() {
    try {
      Object res = javonetHandle.<NObject>get("PendingOrder");
      if (res == null) return null;
      return ConvertToConcreteInterfaceImplementation(res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public TradeResult(NObject handle) {
