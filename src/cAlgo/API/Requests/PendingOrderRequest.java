...
public abstract class PendingOrderRequest implements Request {
  protected NObject javonetHandle;
  /** GetProperty */
  @MethodTypeAnnotation(type = "GetField")
  public PendingOrderType getPendingOrderType() {
    try {
      Object res = javonetHandle.<NEnum>get("PendingOrderType");
      if (res == null) return null;
      return PendingOrderType.valueOf(((NEnum) res).getValueName());
  ...
  public java.lang.Double getTargetPrice() {
    try {
      java.lang.Double res = javonetHandle.get("TargetPrice");
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setExpiration(Nullable<DateTime> value) {
    try {
      javonetHandle.set("Expiration", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Nullable<DateTime> getExpiration() {
    try {
      Object res = javonetHandle.<NObject>get("Expiration");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setStopLoss(Nullable<java.lang.Double> value) {
    try {
      javonetHandle.set("StopLoss", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Nullable<java.lang.Double> getStopLoss() {
    try {
      Object res = javonetHandle.<NObject>get("StopLoss");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setTakeProfit(Nullable<java.lang.Double> value) {
    try {
      javonetHandle.set("TakeProfit", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Nullable<java.lang.Double> getTakeProfit() {
    try {
      Object res = javonetHandle.<NObject>get("TakeProfit");
      if (res == null) return null;
      return new Nullable<java.lang.Double>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public PendingOrderRequest(NObject handle) {
